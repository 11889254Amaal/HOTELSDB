...
public static void InsertIntoTable() {
	...
	String sql = "INSERT INTO guests (guest_name,guest_phone ,guest_accompanying_members,guest_payment_amount,room_id,hotel_id,created_date,updated_date,is_Active) \r\n"
			+ "VALUES ('MUNA', '9677456',5,200,101,84,'2022-01-01', '2022-01-01', 1),\r\n"
			+ "       ('NORA', '9677452',2,1000,201,107,'2022-02-02', '2022-02-02', 1),\r\n"
			+ "      ('EMEE', '9675432',3,400,301,157,'2022-03-03', '2022-03-03', 1),\r\n"
			+ "       ('SALE', '9577452',4,1200,401,204,'2022-04-04', '2022-04-04', 1),\r\n"
			+ "      ('LAMA', '9377432',9,700,501,226,'2022-05-05', '2022-05-05', 1),\r\n"
			+ "       ('SUHA', '9277452',19,2000,601,230,'2022-02-06', '2022-02-06', 1),\r\n"
			+ "      ('MARIYA', '9677432',23,800,701,242,'2022-03-07', '2022-03-07', 1),\r\n"
			+ "      ('AHMED', '9977432',4,700,801,385,'2022-04-08', '2022-04-08', 1)\r\n";
	Connection con = null;
